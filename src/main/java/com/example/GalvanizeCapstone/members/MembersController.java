...
public class MembersController {
    ...
    public Member addOneMember(@RequestBody Member newMember) {
        if (newMember.getEmail() == null || newMember.getAddress() == null || newMember.getMember_number() < 0 || newMember.getMember_name() == null || newMember.getPhone() == null || newMember.getClaim_id() < 0 || newMember.getBase_state() == null || newMember.getOccurrence_state() == null || newMember.getAuto_1() == null){
